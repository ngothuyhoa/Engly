            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('report_store', $id) }}">
                                @csrf
                                <div class="form-group row custom" >
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            <textarea placeholder="Nhập nội dung report" style="height: 100px" name="report" class="form-control{{ $errors->has('report') ? ' is-invalid' : '' }}"></textarea>
                                            @if ($errors->has('report'))
                                                <span class="invalid-report" role="alert">
