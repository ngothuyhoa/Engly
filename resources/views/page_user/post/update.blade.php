		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12" id="form-post">
					<form action="{{route('post_update', $post->slug)}}" method="POST" enctype="multipart/form-data">
					        {{ csrf_field() }}
						...
						<div class="form-group">
				        	...
				        	<div class="col-md-4">
				        		<input style="margin-top: 10px;width: 600px" class="typeahead" type="text" data-role="tagsinput" name="tag" placeholder="Enter Tag" value="{{ $arrTags }}" />
				        	</div>    
						    
						</div>
						<div class="col-md-10" style="margin-top: 15px;">
							<textarea name="content" class="summernote" style="width: 80%" value="jdhfjhd">{{ $post->content }}</textarea>
					    ...
					    <div class="col-md-11">
					    	<div class="form-group">				                
					            <input type="radio" name="status" value="0" <?php echo checked(0, $post->status)?>>Draft</input>
								<input type="radio" name="status" value="1" <?php echo checked(1, $post->status)?>> Public </input>               
				        	</div>
					    </div>
